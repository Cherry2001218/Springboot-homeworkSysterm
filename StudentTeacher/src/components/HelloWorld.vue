...
<form action="/">
 ...
 <van-swipe :autoplay="3000">
    <van-swipe-item v-for="(image, index) in images" :key="index"@click="getDetail(image.sno)" >
    <img v-lazy="picIp+image.pic" />
   </van-swipe-item>
  </van-swipe>

  <van-grid>
  <van-grid-item icon="fire-o" text="精品课程" />
  <van-grid-item icon="clock-o" text="考研四六级" />
  <van-grid-item icon="video-o" text="训练营" />
